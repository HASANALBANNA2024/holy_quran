...
class _AboutUsScreenState extends State<AboutUsScreen> {
  ...
  Widget _buildProfileCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: const Color(0xFFE1B55E).withValues(alpha: 0.3),
          width: 1.5,
        ),
      ),
      child: Column(
        children: [
          ...
          Chip(
            ...
            backgroundColor: const Color(0xFFE1B55E).withValues(alpha: 0.2),
    ...
    child: Wrap(
      ...
      children: [
        _buildSocialButton(
          Icons.email,
          Colors.red,
          'mailto:support@islamicapp.com',
          'Email',
        ),
        _buildSocialButton(
          Icons.public,
          Colors.blue,
          'https://www.islamicapp.com',
          'Web',
        ),
        _buildSocialButton(
          Icons.facebook,
          Colors.indigo,
          'https://facebook.com/islamicapp',
          'FB',
        ),
      ],
    ),
  ...
  Widget _buildCreditsSection() => Container(
    ...
    child: const Column(
      children: [
        ...
        Text(
          'Al-Quran, Al-Hadith, and all the Islamic scholars.',
          textAlign: TextAlign.center,
        ),
      ],
    ),
  ...
  Widget _buildDuaSection() => const Column(
    children: [
      ...
      SizedBox(height: 8),
      Text(
        'Our Lord! Accept from us. Indeed, You are the All-Hearing.',
...
class IslamicArchPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFFE1B55E).withValues(alpha: 0.1)

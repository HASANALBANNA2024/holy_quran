...
class _SurahDetailScreenState extends State<SurahDetailScreen> {
    ...
    itemPositionsListener.itemPositions.addListener(() {
      ...
      if (positions.isNotEmpty) {
        ...
        bool shouldShowTitle =
            firstItem.index > 0 || firstItem.itemLeadingEdge < 0;
        ...
        if (_scrollController.hasClients) {
          if (shouldShowTitle) {
            _scrollController.jumpTo(280.0);
          } else {
            ...
            if (ayahIndex >= 0 && ayahIndex < _cachedAyahs.length) {
              setState(
                () => _currentlyPlayingAyah =
                    _cachedAyahs[ayahIndex]['globalAyahId'],
              );
            }
          }
        }
  ...
  void _autoScrollToIndex(int index) {
    ...
    int surahNumber = widget.surahIndex + 1;
    int targetIndex = (surahNumber != 1 && surahNumber != 9)
        ? (index == 0 ? 0 : index - 1)
        : index;
    itemScrollController.scrollTo(
      index: targetIndex,
    ...
    try {
      ...
      if (surahNumber != 1 && surahNumber != 9) {
        playlist.add(
          AudioSource.uri(
            Uri.parse(
              "https://cdn.islamic.network/quran/audio/128/$qariId/1.mp3",
            ),
          ),
        );
      }
      for (int i = 0; i < _cachedAyahs.length; i++) {
        ...
        playlist.add(
          AudioSource.uri(
            Uri.parse(
              "https://cdn.islamic.network/quran/audio/128/$qariId/$globalId.mp3",
            ),
          ),
        );
      }
      int playIndex = (surahNumber == 1 || surahNumber == 9)
          ? startAyahIndex
          : (startAyahIndex == 0 ? 0 : startAyahIndex + 1);
              ...
              SliverAppBar(
                ...
                leading: IconButton(
                  icon: Icon(
                    ...
                    color: _showTitleInAppBar ? Colors.white : Colors.grey,
                  ),
            ...
            body: ayahs.isEmpty
                ...
                : ScrollablePositionedList.builder(
                    ...
                    itemBuilder: (context, index) =>
                        _buildAyahItem(ayahs[index], index, viewMode),
                  ),
          ),
        );
      },
          ...
          child: Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () => ShareLogic.shareAyah(
                  arabicText: ayah['arabic'],
                  englishTranslation: ayah['trans'],
              ...
              Consumer<BookmarkProvider>(
                builder: (context, provider, child) {
                  ...
                  return IconButton(
                    icon: Icon(
                      provider.isBookmarked(data)
                          ? Icons.bookmark
                          : Icons.bookmark_border_rounded,
                      color: const Color(0xFF1B5E20),
                    ),
                    onPressed: () => provider.toggleBookmark(data),
                  );
                },
              ),
            ],
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                icon: const Icon(Icons.skip_previous, color: Color(0xFF1B5E20)),
              ...
              IconButton(
                icon: const Icon(Icons.skip_next, color: Color(0xFF1B5E20)),

...
class _TasbihScreenState extends State<TasbihScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // ✅ লজিক আপডেট: LayoutBuilder ব্যবহার করা হয়েছে যাতে বড় বা ছোট সব স্ক্রিনে ফিট হয়
          LayoutBuilder(
                  ...
                  child: IntrinsicHeight(
                    child: Column(
                      children: [
                          ...
                          child: Stack(
                            ...
                            children: [
                              AnimatedContainer(
                                ...
                                width: 280, height: 280, // সামান্য ছোট করা হয়েছে ট্যাবের সেফটির জন্য
                              ...
                              AnimatedContainer(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text("${tasbih.count}", style: const TextStyle(fontSize: 80, color: Colors.white, fontWeight: FontWeight.bold)),
                                    Text(
                        ...
                        // ✅ বাটন এরিয়া (ট্যাবলেট বা ছোট ফোনে ওভারফ্লো রোধ করবে)
                        Padding(
  ...
  Widget _bottomBtn(IconData icon, String label, Color color, VoidCallback onTap) {
    return InkWell(
      ...
      child: Column(
        children: [
          CircleAvatar(backgroundColor: color, radius: 26, child: Icon(icon, color: Colors.white)),
  ...
  // ✅ আপনার কাস্টম সেটআপ কোড (এটি হুবহু রাখা হয়েছে)
